<template>
  <div class="min-h-screen flex items-center justify-center bg-gng px-6">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md mb-7">
      ...
      <form @submit.prevent="login()" class="space-y-4">
        ...
        <div>
          <button
            type="submit"
            class="w-full py-3 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-500 focus:ring-4 focus:ring-blue-300 flex items-center justify-center gap-2">
            <span class="flex">
