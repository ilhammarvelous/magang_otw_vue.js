<template>
    ...
    <div class="p-10 bg-gray-200 min-h-screen mt-10">
        <h1 class="text-3xl ml-5 mt-5 uppercase">Tabel Menu</h1>
                    ...
                    <tr 
                        ...
                        class="bg-white border-b odd:bg-gray-100 even:bg-white text-left">
                            ...
                            <td class="flex items-center mt-2 mb-2">
                                ...
                                <button @click.prevent="destroy(menu.id, index)"  class="flex items-center p-2 px-3 mx-1 text-md font-medium tracking-wide text-white bg-red-600 rounded-lg hover:bg-red-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
    ...
    const destroy = async (id) => {
            swal({
                ...
                if (willDelete) {
                    ...
                    swal("Data menu tidak jadi dihapus");
                }
            });
    };
</script>
